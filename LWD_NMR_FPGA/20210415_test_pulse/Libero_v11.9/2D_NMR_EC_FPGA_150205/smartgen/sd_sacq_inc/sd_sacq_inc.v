...
module sd_sacq_inc(DataA,Sum,Cout);
input [21:0] DataA;
output [21:0] Sum;
output Cout;

    wire Rcout_22_net, inc_1_net, inc_2_net, Rcout_4_net, 
        ...
        inc_22_net, Rcout_15_net, inc_24_net, Rcout_16_net, 
        inc1_25_net, Rcout_17_net, inc_27_net, incb_16_net, 
        inc_28_net, incb_17_net, Rcout_18_net, Rcout_19_net, 
        inc_31_net, Rcout_20_net, inc_33_net, Rcout_21_net, 
        inc_35_net;
    ...
    AND3 TAND2_1_inst(.A(incb_17_net), .B(inc_28_net), .C(
        inc_35_net), .Y(Rcout_22_net));
    ...
    AND3 YAND2_21_inst(.A(DataA[15]), .B(DataA[16]), .C(DataA[17])
        , .Y(inc_27_net));
    INV INV_cout_22_inst(.A(Rcout_22_net), .Y(Cout));
    ...
    AND2 TAND2_0_inst(.A(inc_33_net), .B(DataA[21]), .Y(
        inc_35_net));
