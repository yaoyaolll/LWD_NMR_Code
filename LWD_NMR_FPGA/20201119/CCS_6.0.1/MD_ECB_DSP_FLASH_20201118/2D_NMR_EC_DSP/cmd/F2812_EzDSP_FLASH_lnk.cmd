...
PAGE 0 :
   ...
   /* is fetched from boot ROM. See .reset section below      */
     ...
     RAMOUT     : origin = 0x160000, length = 0x01F000
     RAML0    : origin = 0x008000, length = 0x001200
     RAML1_2    : origin = 0x009E00, length = 0x000200 

/*    FLASH_I    : origin = 0x3DA000, length = 0x001FFF */
...
PAGE 1 : 
   ...
   RAML1    : origin = 0x009C70, length = 0x000190
   myzone   : origin = 0x009200, length = 0x000A70
   plusezone: origin = 0x17F000, length = 0x001000
...
/*** Initialized Sections ***/                                          
  	.cinit			:	LOAD = FLASH_E,	PAGE = 0	/* Load section to Flash */ 
                		RUN = RAML0,  		PAGE = 0    /* Run section from RAM */
	...
	.text 			:  	> FLASH_E   	PAGE = 0    /* Load section to Flash */

	InitCode 		:  	> FLASH_E   	PAGE = 0    /* Load section to Flash */

	Datatable		:   LOAD = FLASH_E,  	PAGE = 0   	/* Load section to Flash */
