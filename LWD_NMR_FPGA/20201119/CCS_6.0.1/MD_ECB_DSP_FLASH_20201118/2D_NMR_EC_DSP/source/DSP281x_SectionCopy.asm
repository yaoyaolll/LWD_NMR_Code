...
;############################################################################
	...
	.global _Datatable_loadstart, _Datatable_runstart, _Datatable_size
...
copy_sections:
    ...
    LCR  copy							; Branch to Copy
   	...
   	MOVL XAR5,#_Datatable_size				; Store Section Size in XAR5
	MOVL ACC,@XAR5						; Move Section Size to ACC
	MOVL XAR6,#_Datatable_loadstart			; Store Load Starting Address in XAR6
    MOVL XAR7,#_Datatable_runstart			; Store Run Address in XAR7
    LCR  copy
